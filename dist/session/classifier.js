 ...
 *     没有 → unclassified
 */
export function classifyRequest(session, requestBody, manager, sessionId) {
    ...
    const firstMessageContent = getFirstUserMessageText(lastMessage ? [...messageHistory, lastMessage] : messageHistory);
 ...
 */
function getTextOnlyContent(msg) {
